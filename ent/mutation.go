...
func (m *ShareMutation) SetUserFileID(i int) {
	m.user_file_id = &i
	m.adduser_file_id = nil
}

// UserFileID returns the value of the "user_file_id" field in the mutation.
func (m *ShareMutation) UserFileID() (r int, exists bool) {
	v := m.user_file_id
	if v == nil {
		return
	}
...
// OldUserFileID returns the old "user_file_id" field's value of the Share entity.
// If the Share object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ShareMutation) OldUserFileID(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldUserFileID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldUserFileID requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldUserFileID: %w", err)
	}
	return oldValue.UserFileID, nil
}

// AddUserFileID adds i to the "user_file_id" field.
func (m *ShareMutation) AddUserFileID(i int) {
	if m.adduser_file_id != nil {
		*m.adduser_file_id += i
	} else {
		m.adduser_file_id = &i
	}
...
// AddedUserFileID returns the value that was added to the "user_file_id" field in this mutation.
func (m *ShareMutation) AddedUserFileID() (r int, exists bool) {
	v := m.adduser_file_id
	if v == nil {
		return
	}
...
// ResetUserFileID resets all changes to the "user_file_id" field.
func (m *ShareMutation) ResetUserFileID() {
	m.user_file_id = nil
	m.adduser_file_id = nil
}

// SetExpiration sets the "expiration" field.
func (m *ShareMutation) SetExpiration(i int) {
	m.expiration = &i
	m.addexpiration = nil
}

// Expiration returns the value of the "expiration" field in the mutation.
func (m *ShareMutation) Expiration() (r int, exists bool) {
	v := m.expiration
	if v == nil {
		return
	}
...
// If the Share object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ShareMutation) OldExpiration(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ShareMutation) AddExpiration(i int) {
...
func (m *ShareMutation) AddedExpiration() (r int, exists bool) {
	v := m.addexpiration
	if v == nil {
		return
	}
...
func (m *ShareMutation) SetClickNumber(i int) {
	m.click_number = &i
	m.addclick_number = nil
}

// ClickNumber returns the value of the "click_number" field in the mutation.
func (m *ShareMutation) ClickNumber() (r int, exists bool) {
	v := m.click_number
	if v == nil {
		return
	}
...
// OldClickNumber returns the old "click_number" field's value of the Share entity.
// If the Share object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ShareMutation) OldClickNumber(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldClickNumber is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldClickNumber requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldClickNumber: %w", err)
	}
	return oldValue.ClickNumber, nil
}

// AddClickNumber adds i to the "click_number" field.
func (m *ShareMutation) AddClickNumber(i int) {
	if m.addclick_number != nil {
		*m.addclick_number += i
	} else {
		m.addclick_number = &i
	}
...
// AddedClickNumber returns the value that was added to the "click_number" field in this mutation.
func (m *ShareMutation) AddedClickNumber() (r int, exists bool) {
	v := m.addclick_number
	if v == nil {
		return
	}
...
// ResetClickNumber resets all changes to the "click_number" field.
func (m *ShareMutation) ResetClickNumber() {
	m.click_number = nil
	m.addclick_number = nil
}

// SetCreateAt sets the "create_at" field.
func (m *ShareMutation) SetCreateAt(t time.Time) {
	m.create_at = &t
}

// CreateAt returns the value of the "create_at" field in the mutation.
func (m *ShareMutation) CreateAt() (r time.Time, exists bool) {
	v := m.create_at
	if v == nil {
		return
	}
...
// OldCreateAt returns the old "create_at" field's value of the Share entity.
// If the Share object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ShareMutation) OldCreateAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldCreateAt is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetCreateAt resets all changes to the "create_at" field.
func (m *ShareMutation) ResetCreateAt() {
	m.create_at = nil
}
...
func (m *ShareMutation) Fields() []string {
	...
	if m.user_file_id != nil {
		fields = append(fields, share.FieldUserFileID)
	}
	if m.expiration != nil {
		fields = append(fields, share.FieldExpiration)
	}
	if m.click_number != nil {
		fields = append(fields, share.FieldClickNumber)
	}
	if m.create_at != nil {
		fields = append(fields, share.FieldCreateAt)
	}
	return fields
}
...
func (m *ShareMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case share.FieldUserFileID:
		return m.OldUserFileID(ctx)
	case share.FieldExpiration:
		return m.OldExpiration(ctx)
	case share.FieldClickNumber:
		return m.OldClickNumber(ctx)
	case share.FieldCreateAt:
		return m.OldCreateAt(ctx)
	}
...
func (m *ShareMutation) AddedField(name string) (ent.Value, bool) {
	switch name {
	case share.FieldUserFileID:
		return m.AddedUserFileID()
	case share.FieldExpiration:
		return m.AddedExpiration()
	case share.FieldClickNumber:
		return m.AddedClickNumber()
	}
	return nil, false
}
